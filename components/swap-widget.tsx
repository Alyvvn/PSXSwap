    ...
    <div className="w-full max-w-3xl mx-auto">
      ...
      <div className="bg-slate-900/90 backdrop-blur-xl rounded-3xl p-1 border border-cyan-400/30 shadow-2xl">
        <div className="bg-black/50 rounded-[22px] overflow-hidden">
          <iframe
            src="https://jumper.exchange/?fromChain=8453&fromToken=0x0000000000000000000000000000000000000000&toChain=8453&toToken=0x4444489570Afd4261d616df00DE1668dAd5F8ceE"
            width="100%"
            height="660"
            style={{
              border: "none",
      ...
      <div className="text-center mt-4">
        <div className="inline-flex items-center gap-2 bg-slate-900/80 backdrop-blur-sm rounded-full px-4 py-2 border border-cyan-400/20">
          ...
          <span className="text-cyan-400 font-mono text-xs">SECURE TRADING TERMINAL</span>
        </div>
      </div>
    </div>
  )
