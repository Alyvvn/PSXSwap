...
export function GlizzyPoker() {
  ...
  const players = [
    ...
    { name: "GlizzyMaster", chips: 3200, status: "active", position: "left" },
    { name: "HotDogKing", chips: 4800, status: "folded", position: "top" },
    { name: "SausageSlayer", chips: 2100, status: "active", position: "right" },
  ]
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="grid md:grid-cols-4 gap-6 mb-6">
        <Card className="bg-black/80 border-gray-700">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-sm text-gray-400">Your Glizzys</div>
          </CardContent>
        </Card>
        <Card className="bg-black/80 border-gray-700">
          <CardContent className="p-4 text-center">
        ...
        <Card className="bg-black/80 border-gray-700">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-sm text-gray-400">Pot Size (Glizzys)</div>
          </CardContent>
        </Card>
        <Card className="bg-black/80 border-gray-700">
          <CardContent className="p-4 text-center">
      ...
      <Card className="bg-gradient-to-br from-green-900/30 to-green-800/30 border-green-500/30 mb-6">
        <CardHeader>
          <CardTitle className="text-white text-center">🌭 Texas Hold'em - Glizzy Stakes 🌭</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="relative aspect-[16/10] bg-green-800/50 rounded-lg border-4 border-green-600/30 p-8">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-yellow-400">1,250 Glizzys 🌭</div>
            ...
            {players.map((player, index) => (
              ...
              >
                <div className="bg-gray-900/80 rounded-lg p-3 text-center border border-gray-600">
                  ...
                  <div className="text-green-400 text-xs">{player.chips} Glizzys</div>
        ...
        <CardContent className="p-6">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400 text-sm">
              Game is in demo mode. Connect your wallet to play with real Glizzys.
            </p>
          </div>
        </CardContent>
      </Card>
