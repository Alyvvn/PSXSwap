...
export function GlizzyWorld() {
  const scrollToGamePortal = () => {
    const gamePortalSection = document.querySelector('[data-section="game-portal"]')
    if (gamePortalSection) {
      gamePortalSection.scrollIntoView({ behavior: "smooth", block: "start" })
    }
  }
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-12">
        ...
        <Card className="bg-black/80 border-gray-800 hover:border-purple-500/50 transition-all duration-300">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-gray-400 text-sm">Industry-leading return rates with transparent odds on every game.</p>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-6">
                Access our premium gaming suite featuring PSX-themed slots, poker, blackjack, and exclusive tournaments.
                All games are password-protected and available only to verified PSX agents.
              </p>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-purple-600/20 to-pink-600/20 rounded-lg p-8 border border-purple-500/30">
                <div className="text-center mb-6">
                  ...
                  <h4 className="text-xl font-bold text-white mb-2">Classified Access Required</h4>
                  <p className="text-gray-400 text-sm">Enter agent credentials to unlock gaming suite</p>
                </div>
                ...
                <div className="text-center">
                  <Badge className="bg-red-600 text-white">ACCESS RESTRICTED</Badge>
                </div>
              </div>
            </div>
          </div>
