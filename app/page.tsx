      ...
      <div className="flex items-center justify-between text-cyan-400 font-mono text-xs max-w-7xl mx-auto px-6 py-3">
        <div className="flex items-center gap-4">
          <div className="flex gap-1.5">
            ...
            ></div>
            <div className="w-2.5 h-2.5 rounded-full bg-green-500 animate-pulse" style={{ animationDelay: "0.4s" }}></div>
          </div>
          <span className="hidden sm:block opacity-80 transition-opacity duration-300 hover:opacity-100">PSX.AGENCY // MAINFRAME v2.1.337</span>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <Link
                ...
                className="text-cyan-300/70 hover:text-cyan-400 \
