...
import { Lock, Gamepad2, Trophy, Eye, EyeOff, Play, Coins, Users, BarChart3, ArrowLeft } from "lucide-react"
      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
        <div className="max-w-6xl mx-auto p-4">
          <div className="text-center mb-8 pt-8">
            ...
            <h2 className="text-4xl font-bold text-white mb-4">🎰 Glizzy World Casino - Access Granted</h2>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
      <div className="max-w-2xl mx-auto p-4">
        <div className="text-center mb-8 pt-8">
          <Link href="/">
            <Button variant="outline" className="border-gray-700 text-gray-300 hover:bg-gray-800 mb-4">
              <ArrowLeft className="h-4 w-4 mr-2" />
              Back to PSX
            </Button>
          </Link>
          <h2 className="text-4xl font-bold text-white mb-4">🔒 Classified Glizzy World</h2>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="border-t border-gray-700 pt-6">
              ...
              <p className="text-gray-300 text-sm mb-4">
                Not an agent yet? Submit your application to join the Glizzy World gaming division.
              </p>
              <textarea
                value={applicationText}
                onChange={(e) => setApplicationText(e.target.value)}
                placeholder="Tell us why you want to become a Glizzy World agent..."
            ...
            <div className="bg-gray-900/50 rounded-lg p-4">
              <h4 className="text-white font-semibold mb-2">What awaits inside Glizzy World:</h4>
              <ul className="text-sm text-gray-300 space-y-1">
                <li>• Glizzy-themed slot machines with progressive jackpots</li>
                <li>• Live poker tables with real Glizzy stakes</li>
                <li>• Blackjack with Glizzy multipliers</li>
