...
export default function GlizzyWorldAuthPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (password === "glizzy123") {
      router.push("/glizzy-world/casino") // Redirect to the actual casino page
    } else {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black relative flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md bg-black/80 border-red-500/30 backdrop-blur-xl shadow-red-500/20 relative z-10">
